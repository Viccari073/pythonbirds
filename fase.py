...
class Fase():
    ...
    def status(self):
        ...
        :return:
        """
        if not self._possui_porco_ativo():  # quando coloca o _ significa que só a classe (ou uma de suas subclasses) 
            # podem fazer uso desse método, ou seja, é um Método protegido.
            return VITORIA
